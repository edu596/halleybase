...
class PDF_Invoice2 extends FPDF
{
// private variables
var $colonnes;
var $format;
...
function addClientAdresse( $cliente,$domicilio,$num_documento,$email,$telefono )
{
    ...
    $this->SetXY( $r1, $y1+6);
    $this->SetFont( "Arial", "", 9);
    $this->MultiCell( 150, 3, $cliente);
    $this->SetXY( $r1, $y1+9);
    $this->MultiCell( 150, 3, $domicilio);
    $this->SetXY( $r1, $y1+13);
    $this->MultiCell( 150, 3, $num_documento);
    $this->SetXY( $r1, $y1+16);
    $this->MultiCell( 150, 3, $email);
    $this->SetXY( $r1, $y1+19);
    $this->MultiCell( 150, 3, $telefono);
}
...
function addCadreTVAs($monto)
{
    ...
    $this->Cell(10,3, "IMPORTE TOTAL CON LETRA");
