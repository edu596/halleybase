...
$rspta = $servicio->ventacabecera($_GET["id"], $_SESSION['idempresa'] );
...
//======= PARA EXTRAER EL HASH DEL DOCUMENTO FIRMADO ========================================
    ...
    while ($regd = $rsptad->fetch_object()) {
        ...
        echo "<td>".$regd->valor_uni_item_14 ."</td>";
    ...
    ?>
        ...
        <tr><td colspan='5'><strong>OP. gravada: </strong></td><td><?php  echo $reg->subtotal; ?></td></tr>
        <tr><td colspan='5' ><strong>OP. exonerado: </strong></td><td>0.00</td></tr>
...
<table border='0'  width='220px' style='font-size: 12px'  align="center">
    ...
    <tr>
      <td colspan="5" align="center"><p1>GRACIAS POR SU PREFERENCIA</p1></td>
    </tr>
