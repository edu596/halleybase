...
function addClientAdresse($fecha,$cliente,$num_documento,$domicilio,$estado,$usuario,$guia)
{
    ...
    $this->SetXY( $r1, $y1+10);
    $this->MultiCell( 150, 3, utf8_decode("DNI/RUC    : ").$num_documento);
...
function addClientAdresse2($fecha,$cliente,$num_documento,$domicilio,$estado,$usuario,$guia)
{
    ...
    $this->SetXY( $r1, $y1+10);
    $this->MultiCell( 150, 3, utf8_decode("DNI           : ").$num_documento);
...
function addCols3( $tab )
{
    ...
    $r2  = $this->w - ($r1 * 2) ;
    $y1  = 54;
    $y2  = $this->h - 40 - $y1; // para el largo del cuadro del primer detalle
    $this->SetXY( $r1, $y1 );
    $this->Rect( $r1, $y1, $r2, $y2, "D");
    $this->Line( $r1, $y1+6, $r1+$r2, $y1+6);
    $colX = $r1;
