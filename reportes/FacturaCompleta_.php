...
// Client address
function addClientAdresse($fecha,$cliente,$num_documento,$domicilio,$estado,$usuario,$guia, $tipopago, $nroreferencia)
{
    $r1     = $this->w - 190;
    $r2     = $r1 + 68;
    $y1     = 24;
...
function addCols( $tab )
{
    ...
    $r2  = $this->w - ($r1 * 2) ;
    $y1  = 54;
    $y2  = $this->h - 50 - $y1; // para el largo del cuadro del primer detalle
    $this->SetXY( $r1, $y1 );
...
function addTVAs2( $igv, $total, $moneda, $tdescuento )
{
    $this->SetFont('Arial','',8);
