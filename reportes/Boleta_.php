...
// Client address
function addClientAdresse($fecha,$cliente,$domicilio,$num_documento,$estado,$usuario, $guia, $tipopago, $nroreferencia)
{
    $r1     = $this->w - 190;
    $r2     = $r1 + 68;
    $y1     = 24;
...
function addCadreEurosFrancs()
{
    ...
    $this->SetFont( "Arial", "B", 8);
    $this->SetXY( $r1, $y1+5 );
    $this->Cell(35,4, "Total descuento. S/", 0, 0, "C");
...
//                  "qte"     => qte,
//                  "tva"     => code_tva );
function addTVAs($total, $moneda, $tdescuento, $ipagado, $saldo )
{
    $this->SetFont('Arial','',8);
...
function addTVAs2($total, $moneda, $tdescuento, $ipagado, $saldo )
{
    $this->SetFont('Arial','',8);
